...
export const Polaroid: React.FC<PolaroidProps> = ({
    ...
    const paperProps = {
        backdrop: {
            invisible: noBackdrop,
        },
        paper: {
            elevation: elevation,
            sx: {
                ...style,
                height: image.orientation === 'portrait' ? '100%' : 'unset',
            }
        },
    }
    ...
    return (<Dialog
        ...
        <div className="modal-wrap" onClick={onClick}
             style={{
                 ...
                 boxShadow: 'rgb(0 0 0 / 83%) 0em 0em 6em -1em inset',
                 backgroundRepeat: 'repeat',
                 backgroundSize: '100px 100px',
             }}
        >
            <div className="modal-content">
                {/*<img id="focused-image" alt="focused image" src={imagePath}/>*/}
                <img
                    id="focused-image"
                    alt="focused image"
                    src={image.path}
